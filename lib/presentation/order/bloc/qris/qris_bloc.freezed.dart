...
mixin _$QrisState {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(QrisStatusResponseModel qrisStatusResponse)? statusCheck,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
...
class _$StatusCheckImpl with DiagnosticableTreeMixin implements _StatusCheck {
  const _$StatusCheckImpl(this.qrisStatusResponse);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'QrisState.statusCheck(qrisStatusResponse: $qrisStatusResponse)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('qrisStatusResponse', qrisStatusResponse));
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return statusCheck(qrisStatusResponse);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return statusCheck?.call(qrisStatusResponse);
  }
...
abstract class _StatusCheck implements QrisState {
  const factory _StatusCheck(final QrisStatusResponseModel qrisStatusResponse) =
      _$StatusCheckImpl;
